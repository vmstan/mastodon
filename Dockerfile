...
COPY --from=docker.io/mwader/static-ffmpeg:latest /ffmpeg /usr/local/bin/ffmpeg
COPY --from=docker.io/mwader/static-ffmpeg:latest /ffprobe /usr/local/bin/ffprobe
